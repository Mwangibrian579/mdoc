...
<body>
    <div class="container">
        ...
        <nav class="mb-4">
            <a class="btn btn-primary mr-2" href="patlogin.php">Patient Login</a>
            <a class="btn btn-primary mr-2" href="First Aid.php">First Aid</a>
            <a class="btn btn-primary mr-2" href="Registration.php">New patient Registration</a>
            <a class="btn btn-primary" href="contacts.php">Contact us</a>
        </nav>
